const route = {
    ...
    'titleCreator': {
        default: null,
        type: Function,
        desc: '用来自定义创建标题的方法，本方法执行需要返回HTMLElement类型参数，该方法接收title,close,focus,contextmenu四个参数，close方法可以关闭当前页面，focus方法可以聚焦当前页面,contextmenu方法可以唤起右键菜单。[该属性为定制化属性，仅在customMode下生效]'
    },
    // 页面视图容器
    'viewWrapper': {
        default: null,
